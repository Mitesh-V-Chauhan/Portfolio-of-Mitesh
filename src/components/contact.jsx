...
const contact = () => {
  return (
    <div className="w-full h-screen bg-[#754E1A] py-20 px-20 flex rounded-tl-3xl rounded-tr-3xl">
        <div className="flex flex-col h-full justify-between w-1/2 font-grotesk"> 
        <div className="heading">
            <h1 className="text-[10vw] uppercase leading-none -mb-10 hover:text-orange-400 hover:scale-110" style={{ wordSpacing: '10px'}}>CONNECT</h1>
            <h1 className="text-[10vw] uppercase leading-none -mb-10 hover:text-orange-400 hover:scale-110" style={{ wordSpacing: '10px'}}>With Me</h1>
        </div>
        <div>
            {/* <h3 className="font-['Neue_Montreal'] hover:bg-[url()]">Designed and Developed by: MITESH CHAUHAN</h3> */}
            <p class="text-sm text-[20px] font-light font-montreal">
        ...
        <div className="flex flex-col justify-between gap-20 h-full w-1/2 font-grotesk">
        <div>
        <div className="heading">
    ...
    <div>
    <h4 className="font-montreal">*Desktop Version</h4>
      </div>
    </div>  
